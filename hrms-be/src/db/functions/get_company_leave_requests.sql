...
BEGIN
    RETURN QUERY
    SELECT lr.id, lr.employee_id, lr.leave_type_id, lt.name AS leave_type_name, lr.company_id, lr.start_date, lr.end_date, lr.total_days, lr.reason, lr.status, lr.created_at, lr.updated_at
